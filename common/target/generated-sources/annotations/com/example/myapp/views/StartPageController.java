...
public class StartPageController extends FormController implements IStartPageController, FormController.CloneableFormController<StartPageController> {
    private GroupModel viewModel;
    public StartPageController(@Inject Controller parent) {
        super(parent);
        this.viewModel = createViewModel();
    }
    public StartPageController(@Inject Controller parent, @Inject GroupModel viewModel) {
        super(parent);
        this.viewModel = viewModel != null ? viewModel : createViewModel();
    }
    public GroupModel createViewModel() {
        return new com.example.myapp.model.GroupModelImpl();
    }
    @Override
    ...
    protected void onStartController() {
        ...
        setView(new StartPage(new ViewContext<GroupModel>(this, viewModel)));
    }
    @Override
